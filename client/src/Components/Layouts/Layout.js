...
const Layout = () => {
  ...
  return (
    ...
    //   </main>
    // </div>
    <div className="relative flex flex-col bg-gradient-to-b from-slate-400 to-slate-300 text-slate-950">
  <Header />
  <main className="mt-[3.15rem] flex h-[calc(100vh-3.15rem)] whitespace-nowrap bg-gradient-to-b from-gray-200 to-gray-300">
    {location === "/dash" ? "" : <Nav />}
    {user ? (
      <div className="outlet-border z-[1] mt-1 w-full overflow-y-auto bg-white p-4 text-gray-900 bg-gradient-to-b from-gray-200 to-gray-300 lg:p-10">
        <Outlet />
      </div>
    ) : (
      // <p>Login to continue</p>
